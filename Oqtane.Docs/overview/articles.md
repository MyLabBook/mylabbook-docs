# MyLabBook Related Articles

![articlesbanner](./assets/articles-banner.png)

Since MyLabBook is a new ELN platform and it is built on the [Oqtane framework](https://oqtane.org), then most of these articles are references to the Oqtane framework. 
